"""
Django settings for yitest_402 project.
...
WSGI_APPLICATION = 'yitest_402.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "yitest_402 API",
    "DESCRIPTION": "API documentation for yitest_402 App",
    "VERSION": "v1",
}
